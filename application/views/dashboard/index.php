<div class="ramom-modern-header">
    <div class="ramom-header-content">
		...
		<?php if (get_permission('student_attendance', 'is_add')): ?>
			...
			<a href="<?php echo base_url('school_settings'); ?>" class="ramom-action-btn"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
