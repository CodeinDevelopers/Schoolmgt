...
<?php if (is_superadmin_loggedin() || is_admin_loggedin() || is_accountant_loggedin()) { ?>
       <!---Admin fees summery--->
            <div class="row">
                <div class="col-md-12">
		...
		<section class="panel">
			...
			<div class="panel-body">  
				...
				<table class="table table-bordered table-hover table-condensed table-export" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th width="50"><?php echo translate('sn'); ?></th>
