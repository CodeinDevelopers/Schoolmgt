...
<div class="dashboard-page" style="padding:0px;">
    ...
    <div class="cdev-modern-header">
        ...
        <span><?=translate('class')?>: <span id="admission-number"><span style="font-weight: bold;"><?=html_escape($class_name)?></span>
                    ...
                    <div class="cdev-header-info">
        <span><?=translate('admission_no')?>: <span id="admission-number"><span style="font-weight: bold;"><?=html_escape($register_no)?> </span></span></span>
