	...
	<section class="body">
		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
                ...
                <a class="page-title-icon cdev-action-btn" href="<?php echo (current_url() == base_url('dashboard')) ? base_url('dashboard') : (isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : base_url('dashboard')); ?>">
