<header class="header">
    <div class="logo-env">
        ...
        <div class="visible-xs toggle-sidebar-left" id="menuButton" data-toggle-class="sidebar-left-opened" data-target="html" data-fire-event="sidebar-left-opened">
            <!-- Default Menu Icon -->
            <svg id="menuIcon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
            ...
            <!-- Close Icon -->
            <svg id="closeIcon" fill="currentColor" viewBox="0 0 200 200" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" style="display: none; vertical-align: middle;" aria-hidden="true">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                    <title></title>
        ...
        <ul class="header-menu">
            ...
            <li>
                <div class="header-menu-icon sidebar-toggle" data-toggle-class="sidebar-left-collapsed" data-target="html" data-fire-event="sidebar-left-toggle">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true" class="menu-icon">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path d="M7.96997 2V22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M14.97 9.43994L12.41 11.9999L14.97 14.5599" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                    </svg>

                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="arrow-icon" style="display:none;"  width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M21.97 15V9C21.97 4 19.97 2 14.97 2H8.96997C3.96997 2 1.96997 4 1.96997 9V15C1.96997 20 3.96997 22 8.96997 22H14.97C19.97 22 21.97 20 21.97 15Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M14.97 2V22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M7.96997 9.43994L10.53 11.9999L7.96997 14.5599" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                </div>
            </li>
            <!-- full screen button -->
            <li>
            ...
            <li>
                ...
                <div class="dropdown-menu header-menubox qmsg-box-mw">
                    <div class="notification-title">
                        ...
                        </svg> <?php echo translate('message'); ?>
                    </div>
                    <div class="content">
                        <ul>
                            <?php
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle header-menu-icon" data-toggle="dropdown"
                    ...
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" style="margin-right: 2px;" aria-hidden="true">
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M2 12C2 8.22876 2 6.34315 3.17157 5.17157C4.34315 4 6.22876 4 10 4H14C17.7712 4 19.6569 4 20.8284 5.17157C22 6.34315 22 8.22876 22 12V14C22 17.7712 22 19.6569 20.8284 20.8284C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.8284C2 19.6569 2 17.7712 2 14V12Z" stroke="#4d4d4d" stroke-width="1.5"></path>
                            <path d="M7 4V2.5" stroke="#4d4d4d" stroke-width="1.5" stroke-linecap="round"></path>
                            <path d="M17 4V2.5" stroke="#4d4d4d" stroke-width="1.5" stroke-linecap="round"></path>
                            <path d="M2.5 9H21.5" stroke="#4d4d4d" stroke-width="1.5" stroke-linecap="round"></path>
                            <path d="M18 17C18 17.5523 17.5523 18 17 18C16.4477 18 16 17.5523 16 17C16 16.4477 16.4477 16 17 16C17.5523 16 18 16.4477 18 17Z" fill="#4d4d4d"></path>
                            <path d="M18 13C18 13.5523 17.5523 14 17 14C16.4477 14 16 13.5523 16 13C16 12.4477 16.4477 12 17 12C17.5523 12 18 12.4477 18 13Z" fill="#4d4d4d"></path>
                            <path d="M13 17C13 17.5523 12.5523 18 12 18C11.4477 18 11 17.5523 11 17C11 16.4477 11.4477 16 12 16C12.5523 16 13 16.4477 13 17Z" fill="#4d4d4d"></path>
                            <path d="M13 13C13 13.5523 12.5523 14 12 14C11.4477 14 11 13.5523 11 13C11 12.4477 11.4477 12 12 12C12.5523 12 13 12.4477 13 13Z" fill="#4d4d4d"></path>
                            <path d="M8 17C8 17.5523 7.55228 18 7 18C6.44772 18 6 17.5523 6 17C6 16.4477 6.44772 16 7 16C7.55228 16 8 16.4477 8 17Z" fill="#4d4d4d"></path>
                            <path d="M8 13C8 13.5523 7.55228 14 7 14C6.44772 14 6 13.5523 6 13C6 12.4477 6.44772 12 7 12C7.55228 12 8 12.4477 8 13Z" fill="#4d4d4d"></path>
                        </g>
                    </svg>
        ...
        <div id="userbox" class="userbox">
            ...
            <div class="dropdown-menu">
                <ul class="dropdown-user list-unstyled">
                    ...
                    <?php if (!is_student_loggedin()) { ?>
                    <li><a href="<?php echo base_url('profile'); ?>"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <defs>
                    ...
                    <li><a href="<?php echo base_url('profile/password'); ?>"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
                            ...
                            </svg> <?php echo translate('reset_password'); ?></a></li>
                            <?php if (!is_student_loggedin()) { ?>
                    ...
                    <?php if (get_permission('global_settings', 'is_view')): ?>
                        <li role="separator" class="divider"></li>
                        <li><a href="<?php echo base_url('settings/universal'); ?>"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                ...
                                </svg> <?php echo translate('global_settings'); ?></a></li>
                    <?php endif; ?>
                    <?php if (get_permission('school_settings', 'is_view') && !is_superadmin_loggedin()): ?>
                        <li role="separator" class="divider"></li>
                        <li><a href="<?php echo base_url('school_settings'); ?>"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <path d="M21 22V11.5C21 10.0955 21 9.39331 20.6629 8.88886C20.517 8.67048 20.3295 8.48298 20.1111 8.33706C19.6067 8 18.9045 8 17.5 8" stroke="currentColor" stroke-width="1.5"></path>
                                        <path d="M3 22V11.5C3 10.0955 3 9.39331 3.33706 8.88886C3.48298 8.67048 3.67048 8.48298 3.88886 8.33706C4.39331 8 5.09554 8 6.5 8" stroke="currentColor" stroke-width="1.5"></path>
                                        <path d="M12 22V19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                        <path d="M10 5H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                        <path d="M10 8H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                        <path d="M10 11H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                        <path d="M10 14H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                    </g>
                                </svg> <?php echo translate('school_settings'); ?></a></li>
                    <?php endif; ?>
                    <li role="separator" class="divider"></li>
                    <li><a href="<?php echo base_url('authentication/logout'); ?>"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true><g id=" SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <defs>
                                        <style>
                                    ...
                                    <g id="ic-actions-log-out">
                                        <path class="cls-1" d="M15.71,15v4a2,2,0,0,1-2,2h-6a2,2,0,0,1-2-2V5a2,2,0,0,1,2-2h6a2,2,0,0,1,2,2V9"></path>
                                        <line class="cls-2" x1="12.5" y1="11.95" x2="22.5" y2="11.95"></line>
                                        <path class="cls-2" d="M18.82,8l3.44,3.44a.83.83,0,0,1,0,1.18L18.88,16"></path>
                                    </g>
                                </g>
                            </svg> <?php echo translate('logout'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
   ...
   <script>
    ...
    if (sidebarToggle) {
        sidebarToggle.addEventListener('click', function() {
            ...
            arrowIcon.style.display = arrowIcon.style.display === 'none' ? 'block' : 'none';
        });
        
        // Also listen for the sidebar-left-toggle event (if used in your framework)
        document.addEventListener('sidebar-left-toggle', function() {
            const html = document.querySelector('html');
            const menuIcon = sidebarToggle.querySelector('.menu-icon');
            const arrowIcon = sidebarToggle.querySelector('.arrow-icon');
            
            if (html.classList.contains('sidebar-left-collapsed')) {
                menuIcon.style.display = 'none';
    ...
    const expandButton = document.querySelector('.s-expand');
    if (expandButton) {
        expandButton.addEventListener('click', function() {
            const expandIcon = this.querySelector('.expand-full');
            const compressIcon = this.querySelector('.compress-full');
            
            // Toggle visibility
            expandIcon.style.display = expandIcon.style.display === 'none' ? 'block' : 'none';
            compressIcon.style.display = compressIcon.style.display === 'none' ? 'block' : 'none';
        ...
        document.addEventListener('fullscreenchange', function() {
            const expandIcon = expandButton.querySelector('.expand-full');
            const compressIcon = expandButton.querySelector('.compress-full');
