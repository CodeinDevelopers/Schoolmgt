<header class="header">
	<div class="logo-env">
			<img class="logo" src="<?=$this->application_model->getBranchImage(get_loggedin_branch_id(), 'logo-small')?>" height="40">
