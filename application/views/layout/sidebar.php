                ...
                <ul class="nav nav-main">
                    ...
                    <?php if (is_superadmin_loggedin()) { ?>
                        <li class="nav-parent <?php if ($main_menu == 'dashboard') echo 'nav-active nav-expanded'; ?>">
                            <a> <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
                    ...
                    ?>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'frontend') echo 'nav-expanded nav-active'; ?>">
                                <a><svg version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xml:space="preserve" fill="currentColor" width="24px" height="24px" style="display: inline-block; vertical-align: middle;" aria-hidden="true">
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            ...
                                            <path class="st0" d="M24,28H8c-2.2,0-4-1.8-4-4V8c0-2.2,1.8-4,4-4h16c2.2,0,4,1.8,4,4v16C28,26.2,26.2,28,24,28z"></path>
                                            <line class="st0" x1="10" y1="16" x2="22" y2="16"></line>
                                            <line class="st0" x1="10" y1="12" x2="22" y2="12"></line>
                                            <line class="st0" x1="10" y1="20" x2="22" y2="20"></line>
                                        </g>
                                    </svg> <span><?php echo translate('frontend'); ?></span></a>
                                <ul class="nav nav-children">
