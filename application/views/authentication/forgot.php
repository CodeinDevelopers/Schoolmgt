...
<head>
    ...
    <meta name="author" content="Acamedium">
            ...
            <div class="vercel-card rounded-lg p-8">
                ...
                if($this->session->flashdata('reset_res')){
                    if($this->session->flashdata('reset_res') == 'true'){
                        echo '<div class="mb-6 p-4 rounded-md bg-green-50 text-green-700">Password reset email sent successfully. Check email</div>';
                    }elseif($this->session->flashdata('reset_res') == 'false'){
                        echo '<div class="mb-6 p-4 rounded-md bg-red-50 text-red-700">You entered the wrong email address</div>';
                    }
                }
                ?>
                ...
                <?php echo form_open($this->uri->uri_string()); ?>
                    <div class="space-y-5">
                        <div class="<?php if (form_error('username')) echo 'has-error'; ?>">
                            ...
                            <?php if (form_error('username')): ?>
                                <p class="text-red-600 text-sm mt-1"><?php echo form_error('username'); ?></p>
                            <?php endif; ?>
                        </div>
